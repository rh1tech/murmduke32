...
#ifdef RP2350_PSRAM
extern struct weaponhit *hittype;
#else
extern EXT_RAM_ATTR struct weaponhit hittype[MAXSPRITES];
#endif

extern input loc;
/* recsync already declared above at line 356 */
...
#ifdef RP2350_PSRAM
extern int32_t *myxbak, *myybak, *myzbak;
#else
...
#ifdef RP2350_PSRAM
extern int32_t *oldipos;
extern int32_t *bakipos;
extern int32_t **curipos;
#else
